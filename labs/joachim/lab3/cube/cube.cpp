...
class harIkkeKreativitet : public Framework::GLFWApplication{
    ...
    virtual void Run() {
        ...
        while(!glfwWindowShouldClose(window)){
            ...
            glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT); //clears the depth buffer so previous data is removed
            cubeVAO->Bind();          
            shaderProgram->Bind();     
            ...
            glDrawElements(GL_TRIANGLES, cubeVAO->GetIndexBuffer()->GetCount(), GL_UNSIGNED_INT, (const void*)0);
            ...
            glDrawElements(GL_TRIANGLES, cubeVAO->GetIndexBuffer()->GetCount(), GL_UNSIGNED_INT, (const void*)0); //Draws/renders elements to screen
            //^param1: specifies that the elements will be drawn as triangles. param2: how many indices that will be drawn. param3: type of the drawn indicies in element buffer. param4: where the start in element buffer is (0=beginning)
