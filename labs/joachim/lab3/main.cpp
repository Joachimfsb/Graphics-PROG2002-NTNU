...
class harIkkeKreativitet : public Framework::GLFWApplication{
    ...
    void createChessBoard(){
        auto chessBoardVerticies = GeometricTools::UnitGridGeometry2D<rows, cols, true>(); //data for verticies
    ...
    virtual bool Init(){
        ...
        viewMatrix = glm::lookAt(glm::vec3(0, 0, 5), glm::vec3(0, 0, 0), glm::vec3(0, 1, 0)); //camera
        ...
        auto translate = glm::translate(model, {0.0f, -0.4f, 3.0f});

        chessboardModelMatrix = translate * rotate * scale; //scaling first, then rotation and the translation
    ...
    virtual void Run() {
        ...
        while(!glfwWindowShouldClose(window)){
            ...
            chessVAO->Bind();          
            shaderProgram->Bind();       
            shaderProgram->UploadUniformMatrix4("u_ModelMatrix", chessboardModelMatrix);
