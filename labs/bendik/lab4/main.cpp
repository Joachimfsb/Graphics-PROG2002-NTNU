...
class lab4App : public Framework::GLFWApplication {
private:
...
public:
    lab4App(const std::string& name,  const std::string& version, const int screenWidth, const int screenHeight) : GLFWApplication(name, version, screenWidth, screenHeight) {}
    ~lab4App() {
    ...
    virtual void Run() {
        ...
        RenderCommands::SetClearColor(glm::vec4(0.52f, 0.81f, 0.92f, 1.0f));
        double t = 0.0;
        glfwSetTime(t);
...
lab4App app("Chessboard floor", "ver1", 1000, 1000);
